          ...
          <div className="px-4 pt-2 pb-4 space-y-2 relative max-h-[calc(100vh-88px)] overflow-y-auto">
            ...
            {[
              ...
              >
                ...
                <div className="absolute inset-0 bg-amber-500 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300 transform scale-95 group-hover:scale-100"></div>
                <div className="absolute inset-0 bg-amber-500 rounded-lg opacity-0 group-hover:opacity-30 blur transition-all duration-300"></div>
              </a>
            ))}
            ...
            <div className="pt-2 space-y-3">
              ...
              >
                <span className="relative z-10">Login</span>
                <div className="absolute bottom-1 left-4 w-0 h-0.5 bg-amber-500 group-hover:w-16 transition-all duration-300"></div>
              </a>
              <a
                href="/register"
                onClick={() => setIsMenuOpen(false)}
                className="group relative block w-full bg-slate-700 text-white px-4 py-3 rounded-xl text-sm font-semibold shadow-lg shadow-rose-500/30 hover:shadow-rose-500/50 transition-all duration-300 overflow-hidden"
              >
                <div className="absolute inset-0 bg-slate-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-1000 bg-gradient-to-r from-transparent via-white/20 to-transparent"></div>
