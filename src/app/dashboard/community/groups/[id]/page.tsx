...
function GroupDetailPage() {
      ...
      {isPending ? (
        ...
        <>
          <div className="relative mb-8">
            ...
            <div className="h-64 overflow-hidden rounded-xl relative bg-opacity-50">
  <Image
  ...
  />
  <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col justify-end p-6 z-10">
